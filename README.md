...
##### Tidslinjen blev inte som den skulle. Jag var kluven om jag skulle koda eller bara photoshopa. Jag valde till slut att photoshopa bilden och det ledde till att jag inte så enkelt kunnat lägga in länken till min uppsats "[Internets Historia](https://docs.google.com/document/d/1_dmLKg3yefED4GrWwuQtmYNzu2n8Hvh8/edit)". Detta var för att bilden blev alldeles för stor och jag fick svårigheter med att göra något mer med hemsidan. Min dator kunde inte hantera det och slockna flertalet gånger.
